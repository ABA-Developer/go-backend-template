...
type Repository interface {
	ReadMenuPermissionListQuery(ctx context.Context, args ReadMenuPermissionService) (data []entities.MenuPermission, err error)
	ReadMenuPermissionByIdQuery(ctx context.Context, MenuPermissionID int) (data entities.MenuPermission, err error)
	ReadMenuPermissionCount(ctx context.Context, args ReadMenuPermissionService) (count int, err error)
