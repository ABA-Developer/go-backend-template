...
// ReadMenuPermissionUseCase godoc
...
// @Success      200      {object}  presenter.ResponsePayloadPaginate{data=[]menuPermissionPresenter.ReadMenuPermissionResponse} "Successfully get menu permission list"
...
// @Failure      500      {object}  presenter.ResponsePayloadMessage "Internal Server Error (Query parsing or usecase failure)"
// @Security     BearerAuth
