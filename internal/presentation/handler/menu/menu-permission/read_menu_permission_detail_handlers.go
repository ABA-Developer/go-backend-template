...
// ReadMenuPermissionDetailUseCase godoc
...
// @Success      200 {object}  presenter.ResponsePayloadData{data=menuPermissionPresenter.ReadMenuPermissionResponse} "Successfully get menu permission detail"
