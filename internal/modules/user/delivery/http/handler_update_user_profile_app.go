...
// @Security     BearerAuth
// @Router       /users/me [put]
func UpdateProfileApp(usecase domain.UserUsecase, validate *validator.Validator) fiber.Handler {
	return func(c *fiber.Ctx) (err error) {
		...
		payload := request.ToDomainPayload(userIDFromToken, userIDFromToken)
