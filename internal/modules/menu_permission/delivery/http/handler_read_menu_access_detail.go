...
func ReadMenuPermissionDetail(usecase domain.MenuPermissionUsecase) fiber.Handler {
	return func(c *fiber.Ctx) (err error) {
		...
		data, err := usecase.ReadMenuPermissionDetailUsecase(c.UserContext(), menuPermissionID)
		if err != nil {
