...
// @Tags         Authentication
// @Produce      json
// @Success      200 {object} presenter.ResponsePayloadData{data=UserResponse} "Successfully retrieved user profile"
...
// @Security     BearerAuth
// @Router       /auth/me [get]
func AuthMe(usecase domain.AuthUsecase) fiber.Handler {
